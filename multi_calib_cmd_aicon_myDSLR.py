...
import camera_calibrate_input_rms_aicon_myDSLR as stereoCalib
# import camera_calibrate_input_rms_ext_aicon as stereoCalib
    ...
    def one_process(self, args):
        ...
        if(args.action == 1):
            ...
            if (args.path_img != None):
                ...
                objCal.read_images_with_mono_stereo(args.path_img, opt1=user_calib_option('GUESS',objCal.getName()), opt2=user_calib_option('GUESS',objCal.getName()))
            elif (args.path_point != None):
                print("\nPOINT ", args.path_point)
                objCal.initialize(args.path_point)
                objCal.read_points_with_mono_stereo(args.path_point, None, None, opt1=user_calib_option('GUESS',objCal.getName()), opt2=user_calib_option('GUESS',objCal.getName()))
