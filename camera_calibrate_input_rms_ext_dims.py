    ...
    def calc_rms_stereo2(self, obj_points, imgpoints_l, imgpoints_r, A1, D1, A2, D2, R, T):
        ...
        for i in range(len(obj_points)):
            ...
            test222 = np.asmatrix(
                ...
                #in-lab gaze pos
                # [[0.6557919, -0.2051818, 0.4349177, 1],
                #  [0.1966726, -0.2736979, 0.3514637, 1],
                #  [0.7022939, -0.2094974, 0.3364755, 1],
                #  [0.1892546, -0.2912984, 0.1948207, 1],
                #  [0.7371346, -0.2156764, 0.217438, 1],
                #  [0.1862095, -0.30678, -0.0046036, 1],
                #  [0.774699, -0.2201057, 0.0733522, 1],
                #  [0.1813803, -0.3133029, -0.1982094, 1],
                #  [0.7925431, -0.2905016, -0.1469203, 1],
                #  [0.5511207, -0.2292899, 0.4082588, 1],
                #  [0.6449881, -0.2945669, -0.1627241, 1],
                #  [0.4292868, -0.250274, 0.3815847, 1],
                #  [0.5212195, -0.3019321, -0.1872921, 1],
                #  [0.3035472, -0.2650059, 0.3631297, 1],
                #  [0.3262153, -0.3094388, -0.198868, 1],
                #  [0.656928, -0.1147886, 0.5092614, 1],
                #  [0.0688799, -0.1687592, 0.4958798, 1],
                #  [0.7368524, -0.1241445, 0.2447031, 1],
                #  [0.1045745, -0.3022772, 0.1075335, 1],
                #  [0.7925773, -0.1321859, 0.0113754, 1],
                #  [0.1064825, -0.1699947, -0.0035593, 1],
                #  [-0.2075255, -0.3019077, 0.0788933, 1],
                #  [0.2966524, -0.1496264, 0.0039831, 1],
                #  [0.2511153, -0.1653159, 0.5132911, 1],
                #  [0.4128626, -0.1579227, 0.0555399, 1],
                #  [0.411375, -0.1475727, 0.5387623, 1],
                #  [0.5940548, -0.1473022, 0.0628728, 1],
                #  [0.622692, -0.157078, 0.5414237, 1],
                #  [0.7151473, -0.1051563, 0.0319723, 1],
                #  [0.8149729, -0.6536473, -0.9357355, 1],
                #  [0.557344, -0.6688397, -0.95814, 1],
                #  [0.2783829, -0.6931193, -0.9754802, 1],
                #  [1.0918512, -0.093266, 0.2536281, 1],
                #  [0.970267, -0.1283677, 0.2151413, 1],
                #  [1.1152208, -0.0129442, 0.224172, 1],
                #  [1.0025572, -0.0284731, 0.1846772, 1],
                #  [1.038371, -0.0708543, 0.2219904, 1],
                #  [-0.7657345, -0.1849349, 0.0788236, 1],
                #  [-0.876732, -0.1487395, 0.1232199, 1],
                #  [-0.7922609, -0.0891866, 0.045442, 1],
                #  [-0.8973954, -0.0684034, 0.090222, 1],
                #  [-0.8322579, -0.1227715, 0.0871173, 1],
                #  [0.6431332, -0.0830204, -0.0061596, 1],
                #  [0.6261507, -0.0154173, -0.062109, 1],
                #  [0.500429, -0.1074735, 0.0104124, 1],
                #  [0.5032426, -0.0196985, -0.0704738, 1],
                #  [0.3582749, -0.0897907, -0.0334581, 1],
                #  [0.3809114, -0.0174177, -0.0813364, 1],
                #  [-0.0238482, -0.0977124, 0.0247469, 1],
                #  [-0.0182864, 0.0258685, 0.0448807, 1],
                #  [0.1017314, -0.1174084, 0.0515617, 1],
                #  [0.0880668, 0.0264937, 0.0488265, 1],
                #  [0.2113904, -0.0978172, 0.0280262, 1],
                #  [0.2082596, 0.0236878, 0.0423055, 1],
                #  [0.2092983, -0.2199947, 0.3645404, 1],
                #  [-0.010623, -0.2019946, 0.382999, 1],
                #  [0.2158841, -0.1750582, 0.3334661, 1],
                #  [-0.0185271, -0.1535269, 0.3477126, 1],
                # in-lab gaze pos - ICMU
                [
                    [0.5231382, -0.6038082, -0.003844, 1],
                    [-0.3961034, -0.6023438, -0.0085042, 1],
                    [0.5238891, -0.0949363, -0.0044083, 1],
                    [-0.3953243, -0.0936769, -0.0088954, 1],
                    [-0.4338465, -0.6012246, 0.0142183, 1],
                    [-1.1450606, -0.5983029, 0.5969201, 1],
                    [-0.4321487, -0.0927429, 0.0131144, 1],
                    [-1.1446483, -0.0895427, 0.5943853, 1],
                    [0.5343339, 0.0448567, 0.0669726, 1],
                    [-0.3847919, 0.0463192, 0.0697775, 1],
                    [0.5351937, 0.5399297, 0.1833785, 1],
                    [-0.3839885, 0.5425329, 0.181877, 1],
                    [-0.4167592, 0.0889377, 0.1112234, 1],
                    [-1.183771, -0.022192, 0.6055834, 1],
                    [-0.4176926, 0.5855093, 0.2213157, 1],
                    [-1.1858623, 0.4744807, 0.714252, 1],
                    [0.9974587, -0.5022418, 0.4098673, 1],
                    [0.5834933, -0.5058143, 0.1145919, 1],
                    [0.9975265, 0.4170667, 0.3983219, 1],
                    [0.5833192, 0.4135144, 0.1029161, 1],
